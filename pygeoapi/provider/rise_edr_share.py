...
from pygeoapi.provider.rise_api_types import JsonPayload, Url

"""This file exists solely to prevent circular imports due to two files both need to import this, but shouldn't import each other"""
